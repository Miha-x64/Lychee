 ...
 */
@JvmField
val byteCollection: DataType.Collect<ByteArray, Byte> = CollectionNoOp(byte)

/**
 * Stores [ShortArray] instances as collections of [Short]s.
 */
@JvmField
val shortCollection: DataType.Collect<ShortArray, Short> = CollectionNoOp(short)

/**
 * Stores [IntArray] instances as collections of [Int]s.
 */
@JvmField
val intCollection: DataType.Collect<IntArray, Int> = CollectionNoOp(int)

/**
 * Stores [LongArray] instances as collections of [Long]s.
 */
@JvmField
val longCollection: DataType.Collect<LongArray, Long> = CollectionNoOp(long)

/**
 * Stores [FloatArray] instances as collections of [Float]s.
 */
@JvmField
val floatCollection: DataType.Collect<FloatArray, Float> = CollectionNoOp(float)

/**
 * Stores [DoubleArray] instances as collections of [Double]s.
 */
@JvmField
val doubleCollection: DataType.Collect<DoubleArray, Double> = CollectionNoOp(double)


private class CollectionNoOp<C, E>(type: Simple<E>) : DataType.Collect<C, E>(type) {
