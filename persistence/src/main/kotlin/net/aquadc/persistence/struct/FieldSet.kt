...
inline operator fun <SCH : Schema<SCH>, F : FieldDef<SCH, *>> FieldSet<SCH, F>.contains(field: FieldDef<SCH, *>): Boolean =
...
/*internal*/ @Deprecated("Don't. Touch. This. Directly.") constructor(
