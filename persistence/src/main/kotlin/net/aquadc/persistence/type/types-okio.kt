...
@JvmField val smallNullableByteString: DataType<ByteString?> = ByteStr(false, Byte.MAX_VALUE.toInt())

@JvmField val mediumByteString: DataType<ByteString> = ByteStr(false, Short.MAX_VALUE.toInt())
@JvmField val mediumNullableByteString: DataType<ByteString?> = ByteStr(false, Short.MAX_VALUE.toInt())

@JvmField val largeByteString: DataType<ByteString> = ByteStr(false, Int.MAX_VALUE)
@JvmField val largeNullableByteString: DataType<ByteString?> = ByteStr(false, Int.MAX_VALUE)
*/
